...
public class CameraTakeFragment extends Fragment {
    ...
    public static final String TAG = CameraTakeFragment.class.getSimpleName();
     ...
     * Activity Result 相关
     */
    public static final int REQUEST_CODE_TAKE = 0x00000123;// 图片选择请求码
    public static final int REQUEST_CODE_SETTING = 0x00001234;// 设置页面请求码
    public static final int REQUEST_CODE_PERMISSIONS = 0x00012345;// 权限申请请求码


    public static CameraTakeFragment newInstance() {
        CameraTakeFragment fragment = new CameraTakeFragment();
     ...
     * 开始拍照
     */
    public void takePhoto(CameraTakeConfig config, CameraTakeCallback callback) {
        this.mConfig = config;
        this.mCameraTakeCallback = callback;
        // 启动相机
            ...
            case REQUEST_CODE_TAKE:
                if (resultCode == Activity.RESULT_OK) {
                    try {
                        ...
                        // 回调
                        mCameraTakeCallback.onResult(mConfig.destFilePath);
                        // 通知文件变更
